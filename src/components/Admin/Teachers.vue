<template>
  <div class="p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
      <h2 class="text-2xl font-semibold text-gray-900 tracking-tight">Teacher Management</h2>
      <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
        ...
        <div class="relative w-full sm:w-64">
          <input
            ...
            class="w-full pl-10 pr-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm text-gray-700"
          />
          <svg
        ...
        <button
          @click="openAddModal"
          class="bg-blue-600 text-white px-5 py-2.5 rounded-xl shadow-sm hover:bg-blue-700 active:scale-95 transition-all duration-150 w-full sm:w-auto"
        >
          + Add Teacher
        </button>
      </div>
          ...
          >
            ...
            <td class="px-6 py-4 flex items-center gap-2">
              ...
              <button
                ...
                class="text-blue-600 hover:text-blue-700 p-1 rounded-full hover:bg-blue-50 transition"
              >
              ...
              <button
                ...
                class="text-red-600 hover:text-red-700 p-1 rounded-full hover:bg-red-50 transition"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                  viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M10 11v6" />
      ...
      >
        ...
        >
          ...
          <form @submit.prevent="isEditing ? updateTeacher() : addTeacher()">
            ...
            <!-- Employment Type -->
            <div class="mb-5">
              <label class="block text-gray-600 text-sm mb-2">Employment Type</label>
      ...
      >
        ...
        >
          ...
          <p class="text-gray-600 mb-6">
            ...
            <strong>{{ teachers[selectedIndex]?.fullName }}</strong>?
          </p>
...
const filteredTeachers = computed(() => {
  ...
  return teachers.value.filter((t) => {
    ...
    const sections = Array.isArray(t.handleSections)
      ? t.handleSections.map((s) => (typeof s === 'object' ? s.section : s)).join(', ').toLowerCase()
      : (t.handleSections || '').toLowerCase()
    const sectionMatch = sections.includes(query)
...
const form = ref({ fullName: '', handleSections: [], employmentType: '' })

const openAddModal = () => {
  isEditing.value = false
  form.value = { fullName: '', handleSections: [], employmentType: '' }
